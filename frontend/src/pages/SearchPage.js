    ...
    return (
        <div id="search-page-layout" className="container">
                    ...
                    <div key={index} className="card">
                        <div className="card__body">
                            <div className="search--item--wrapper--1">
                                <img className="avatar avatar--md" src={user.profile_pic} />
                                <div>
                                    <strong>{user.name}</strong>
                                    <small>@{user.username}</small>
                                    <p>{user.bio}</p>
                                </div>
                                <a href="#" className="btn btn--main--outline btn--sm">Follow</a>
                            </div>
                        </div>
                    </div>
                    ))}
                        ...
                        <div key={index} className="card">
                            <div className="card__body">
                                <div className="search--item--wrapper--2">
                                    <img className="avatar--md" src={article.thumbnail} />
                                    <div>
                        ...
                        <div key={index} className="card">
                            <div className="card__body">
                                <div className="search--item--wrapper--1">
                                    ...
                                    <a href="#" className="btn btn--main--outline btn--sm">Add SKill</a>
                                </div>
                            </div>
                        </div>
                    ))}
                        ...
                        <div key={index} className="card">
                            <div className="card__body">
                                <div className="search--item--wrapper--1">
                                    ...
                                    <a href="#" className="btn btn--main--outline btn--sm">Add Intrest</a>
                                </div>
                            </div>
                        </div>
                    ))}
            ...
            <div className="card card--dark" id="search-categories">
                    <div className="card__body">
                        <h5>Search by:</h5>
                        <p className="category-link category-link--active" onClick={(e) => {toggleCategory(e, 'category-people')}}>People</p>
                        {/* <p className="category-link" onClick={(e) => {toggleCategory(e, 'category-posts')}}>Posts</p> */}
                        <p className="category-link" onClick={(e) => {toggleCategory(e, 'category-articles')}}>Articles</p>
                        <p className="category-link" onClick={(e) => {toggleCategory(e, 'category-skills')}}>Skills</p>
                        <p className="category-link" onClick={(e) => {toggleCategory(e, 'category-interests')}}>Interests</p>
                    </div>
                </div>
            </div>
