                            ...
                            <div className="post-comments-wrapper">
                                {post.comments.map(comment => (
                                    <div key={comment.id} className="post-comment">
                                        ...
                                        <i className="replying-to-text"><small>Replying to  {comment.reply_at.map(user => (<span key={user.id}>- @{user.username}</span>))}</small></i>
                                        <div className="post-contents">
                                            <div className="post-votes">
                                                <i className="fas fa-arrow-alt-up vote-icon up-arrow"></i>
...
>>>>>>> 8576951... Basic quality of life changes to home page. (#71)
